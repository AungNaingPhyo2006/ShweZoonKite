...
import { PlugZap2 } from "lucide-react-native";

const InfoModal = ({ isInfoModal, InfoModalOpen, setIsInfoModal }) => {
	const panResponder = useRef(
		PanResponder.create({
			onStartShouldSetPanResponder: () => true,
			onPanResponderRelease: (e, gestureState) => {
				if (gestureState.dy > 9) {
